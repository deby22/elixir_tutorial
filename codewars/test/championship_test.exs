defmodule TestChampions do
  use ExUnit.Case
  import Champions, only: [count_wins: 2]
  ...
  test "count_wins" do
    assert count_wins(@winner_list, "Portugal") == 1
    assert count_wins(@winner_list, "FootLand") == 0
    assert count_wins(@winner_list, "Spain") == 9
  end
end
